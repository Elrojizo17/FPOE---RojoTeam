...
class Registrar_servicio():
    def __init__(self, vista, tabla):
        ...
        self.url="http://192.168.56.1:8000/v1/servicio"
    ...
    def validar_Servicio(self):
        ...
        response = requests.get("http://192.168.56.1:8000/v1/cliente")
        ...
        response = requests.post("http://192.168.56.1/v1/servicio", data=data)
